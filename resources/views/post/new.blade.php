...
<div class="container-fluid">
    ...
    <div class="col-lg-6">
     <h5> Please create a category before making your post, if your category doesn't exist already. </h5>
          ...
          @if (session('success'))
            ...
            <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
              ...
              <div class="form-group{{ $errors->has('cover_image') ? ' has-error' : '' }}">
                 <label for="cover_image" class="control-label">Choose new Cover Image</label>
                            <input type="file" name="cover_image" class="form-control" id="name" >
